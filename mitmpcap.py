...
class Addon:
    ...
    def __init__(self, createf_oth, createf_net):
        self.createf_oth = createf_oth
        self.createf_net = createf_net
        self.exporter = None
        self.exporter_oth = None
        self.exporter_net = None

    def load(self, entry): # pylint: disable = unused-argument
        self.exporter_oth = self.createf_oth()
        self.exporter_net = self.createf_net()
        

    def done(self):
        self.exporter_oth.close()
        self.exporter_net.close()
        self.exporter = None
...
addons = [Addon(lambda: File('others.pcap'), lambda: File('netflix.pcap'))]
